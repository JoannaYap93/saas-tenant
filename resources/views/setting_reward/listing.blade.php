            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <h4 class="mb-0 font-size-18 mr-2">Setting Reward Listing</h4>
                    <a href="{{ route('setting_reward_add') }}" class="btn btn-sm btn-outline-success waves-effect waves-light mr-2 mb-1"><i class="fas fa-plus"></i> ADD NEW</a>
                </div>
                            ...
                            <tbody>
                                ...
                                @forelse ($records as $rows)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('setting_reward_edit', @$rows->setting_reward_id ) }}" class="btn btn-outline-warning btn-sm mr-2">Edit</a>
...
<!-- Modal -->
 ...
 <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
         <form method="POST" action="{{ route('setting_reward_delete') }}">
             @csrf
