                                    ...
                                    @foreach ($records as $key => $row)
                                        @if ($row->is_deleted == 0)
                                            ...
                                            <tr>
                                                ...
                                                @can('warehouse_manage')
                                                    <td>
                                                        <a href="{{ route('setting_warehouse_edit', ['tenant' => tenant('id'), 'id' => $row->warehouse_id]) }}" class="btn btn-outline-warning btn-sm mr-2">Edit</a>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" action="{{ route('setting_warehouse_delete', ['tenant' => tenant('id')]) }}">
                    @csrf
