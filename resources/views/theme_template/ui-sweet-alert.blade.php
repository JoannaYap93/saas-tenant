...
@section('css')
        <!-- Sweet Alert -->
        <link rel="stylesheet" type="text/css" href="{{ global_asset('assets/libs/sweetalert2/sweetalert2.min.css')}}">
@endsection
...
@section('script')
        ...
        <!-- Sweet alert init js -->
        <script src="{{ global_asset('assets/js/pages/sweet-alerts.init.js')}}"></script> 
