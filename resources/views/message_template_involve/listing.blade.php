                            ...
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="{{route('message_template_involve_listing','reset=1')}}" class="btn btn-danger waves-effect waves-light mr-2"><i class="fas fa-times mr-1"></i> Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{{$rows->message_template_involve_type}}
                                        <br>Updated On:
                                        <b>{{ date_format($rows->message_template_involve_updated, 'Y-m-d h:i A') }}</b></td>
                                    </td>
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('message_template_involve_delete') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="message_template_involve_id" id="message_template_involve_id">
                    </div>
    ...
    <script>
        $(document).ready(function(e) {
            $('.delete').on('click', function() {
                ...
                $(".modal-body #message_template_involve_id").val(id);
            });
        });
    </script>
@endsection
