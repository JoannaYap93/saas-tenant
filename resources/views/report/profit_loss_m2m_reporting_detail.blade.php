...
@section('content')
    <div class="card-body">
        <x-profit_loss_m2m_reporting_detail :records="$profit_loss" :companyExpense="$company_expense" :search="$search" :monthSel="$month_sel" :settingExpense="$setting_expense" :component=true/>
    </div>
@endsection
@section('script')
