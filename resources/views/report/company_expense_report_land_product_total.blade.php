...
@section('content')
    <div class="card-body">
            <x-company_expense_report_land_report_product_detail_total :records="$company_expense_land_product" :settingExpense="$setting_expense" :expenseCategory="$expense_category"
