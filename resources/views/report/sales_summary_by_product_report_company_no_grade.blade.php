...
@section('title')
Sales & Product Summary Report (Company)
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"><span class="mr-2 ">Sales & Product Summary Report (Company)</span></h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item">
                        <a href="javascript: void(0);">Sales & Product Summary Report (Company)</a>
                    </li>
                    ...
                    <div class="col">
                        <form method="POST" action="{{ $submit }}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-daterange input-group" id="datepicker6"
                                            ...
                                            <input type="text" style="width: 75px" class="form-control"
                                                name="sales_from" placeholder="Start Date"
                                                value="{{ @$search['sales_from'] }}" id="start" autocomplete="off">
                                ...
                                <x-option_advance_filter :companySel="$company_sel" :productSel="$product"
                                    :productCategorySel="$product_category_sel" :customerSel="$customer_sel"
                                    :search="$search" />
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <x-advanced_filter :records="$sales_summary_details_by_product_company"
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <x-sales_summary_by_product_report_company_no_grade :records="$sales_summary_details_by_product_company"
                    :company="$company" :product="$product" :search="$search" :component=true />
...
<script>
    let land_arr = [];
        ...
        $(document).ready(function(e) {
            ...
            $("#sales_summary_company_table").parent().freezeTable({
                'freezeColumn': true,
                'shadow': true,
                'scrollable': true,
            });
