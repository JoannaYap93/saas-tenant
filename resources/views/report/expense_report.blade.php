    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18"><span class="mr-2 ">D.O. Expense Reporting</span></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Expense Report</a>
                        </li>
                            ...
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="warehouse_id" id="user_id" class="form-control">
                                ...
                                <div>
                                    ...
                                    :doExpense="$do_expense" :search="$search" :productComponent=true/>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-lg-12">
   ...
   <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <x-expense_report
                    :monthSel="$month_sel" :doExpense="$do_expense" :expenseWtype="$expense_w_type" :search="$search"
                    :companyLand="$company_land" :companyLandSel="$company_land_sel" :companySel="$company_sel" :userSel="$user_sel"
                    :component=true />
                </div>
            </div>
        </div>
