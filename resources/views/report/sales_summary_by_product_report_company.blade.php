...
@section('title')
    Sales & Product Grade Summary Report (Company)
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18"><span class="mr-2 ">Sales & Product Grade Summary Report (Company)</span></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Sales & Product Grade Summary Report (Company)</a>
                        </li>
                        ...
                        <div class="col">
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div class="row">
                                    ...
                                    <x-option_advance_filter :companySel="$company_sel" :productSel="$product" :productCategorySel="$product_category_sel" :customerSel="$customer_sel" :search="$search"/>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <x-advanced_filter :records="$sales_summary_details_by_product_company" :companyCb="$company_cb" :productCb="$product_cb" :search="$search"/>
                                <div class="row mt-3">
                                    <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <x-sales_summary_by_product_report_company :records="$sales_summary_details_by_product_company" :company="$company" :product="$product" :search="$search" :component=true/>
                </div>
            </div>
        </div>
    </div>
