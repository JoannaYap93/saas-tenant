...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18"><span class="mr-2 ">Invoice Daily Report</span></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Invoice Daily Report</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div>
                                    <x-advanced_filter :records="$records" :companyCb="$company_cb" :productCb="$product_cb"  :search="$search"/>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <x-invoice_daily_report :records="$records" :dateRange="$date_range" :product="$product" :component=true/>
                </div>
            </div>
        </div>
    </div>
