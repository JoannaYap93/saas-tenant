...
@section('content')
    <div class="card-body">
        <x-profit_loss_y2y_reporting_detail :records="$profit_loss" :recordslastyear="$profitloss" :companyExpense="$company_expense" :search="$search" :settingExpense="$setting_expense" :component=true/>
    </div>
@endsection
@section('script')
