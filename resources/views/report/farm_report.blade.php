...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18"><span class="mr-2 ">Farm Reporting</span></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Farm Report</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div>
                                    <x-advanced_filter :records="$sales_summary_details_by_farm" :search="$search"
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <x-sales_summary_by_farm_report :records="$sales_summary_details_by_farm" :component=true/>
                </div>
            </div>
        </div>
    </div>
