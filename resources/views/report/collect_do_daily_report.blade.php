...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18"><span class="mr-2 ">Collect + DO (Daily Report)</span></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="javascript: void(0);">Collect + DO (Daily Report)</a>
                        </li>
                        ...
                        <div class="col">
                            <form method="POST" action="{{ $submit }}">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <x-option_filter :companySel="$company_sel" :search="$search"/> --}}
                                </div>
                                <div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <x-collect_do_daily_report :dateRange="$date_range" :company="$company" :products="$products"
    ...
    <script>
     ...
     @if(@$search['company_cb_id'])
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    if (e.land.length > 0) {
                        ...
                        // $('#product_id').html('<option value="">Please Select Product</option>');
                    } else {
                        // $('#product_id').html('<option value="">No Product</option>');
        ...
        function  get_product_by_company_land_id(company_land_id) {
            ...
            let land = "{{ @$search['company_land_id'] ?? null }}";
            let pid =" {{ @$search['product_id'] ?? null }}";
            console.log(pid);
            $.ajax({
