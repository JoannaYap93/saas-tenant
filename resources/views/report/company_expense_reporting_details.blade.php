...
@section('content')
    <div class="card-body">
            <x-company_expense_reporting_details :settingExpense="$setting_expense" :expenseCategory="$expense_category" :monthSel="$month_sel"
            :companyLand="$company_land" :companyExpenseDetail="$company_expense_detail"/>
    </div>
@endsection
@section('script')
