...
class SyncCompanyExpenseItem extends Model
{
    // use InteractsWithMedia;

    protected $table = 'tbl_sync_company_expense_item';
    protected $primaryKey = 'sync_company_expense_item_id';
    const CREATED_AT = 'sync_company_expense_item_created';
    const UPDATED_AT = 'sync_company_expense_item_updated';
    ...
    protected $fillable = [
        ...
        'sync_company_expense_item_unit',
        'sync_company_expense_item_unit_price',
        'sync_company_expense_item_total',
        'company_expense_item_id',
    ];
