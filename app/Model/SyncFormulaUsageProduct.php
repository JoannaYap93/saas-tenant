...
class SyncFormulaUsageProduct extends Model
{
    // use InteractsWithMedia;

    protected $table = 'tbl_sync_formula_usage_product';
    protected $primaryKey = 'sync_formula_usage_product_id';
    const CREATED_AT = 'sync_formula_usage_product_created';
    ...
    protected $fillable = [
        ...
        'sync_formula_usage_product_value_per_tree',
        'sync_formula_usage_product_created',
        'sync_formula_usage_product_id',
        'sync_formula_usage_product_quantity',
    ];
    ...
    {
        return $this->belongsTo(FormulaUsage::class, 'sync_formula_usage_id', 'sync_formula_usage_id');
    }
