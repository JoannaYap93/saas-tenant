...
class DODailyExport implements FromView, WithEvents,ShouldAutoSize,WithColumnFormatting
{
    public function __construct($view, $delivery_order_item_details, $search, $date_range)
    {
        $this->view = $view;
