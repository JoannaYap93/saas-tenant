...
class CompanyExpenseReportExport implements FromView, WithEvents,ShouldAutoSize,WithColumnFormatting
{
    public function __construct($view, $company_expense, $search)
    {
        $this->view = $view;
        $this->record = $company_expense;
        $this->search = $search;
    }
