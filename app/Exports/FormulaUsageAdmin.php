...
class FormulaUsageAdmin implements FromView, WithEvents,ShouldAutoSize,WithColumnFormatting
{
    public function __construct($view, $formula_usage_info, $search)
    {
        $this->view = $view;
        $this->formula_usage_info = $formula_usage_info;
        $this->search = $search;
    }
    ...
    public function view(): View
    {
        return view($this->view, [
          ...
          'settingFormulaCategory' => SettingFormulaCategory::get_selection(),
          'formulaUsage' => $this->formula_usage_info,
