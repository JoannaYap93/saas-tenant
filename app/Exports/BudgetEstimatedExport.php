...
class BudgetEstimatedExport implements FromView, WithEvents, ShouldAutoSize, WithColumnFormatting
{
    public function __construct($view, $search, $products, $product_category, $expense_category, $expense_item, $company, $monthSel, $record_sales_budget, $record_expense_budget, $record_sales, $record_expense,$record_expense_item, $year)
    {
        $this->view = $view;
        $this->search = $search;
        $this->year = $year;
        ...
        $this->record_sales_budget = $record_sales_budget;
        $this->record_expense_budget = $record_expense_budget;
        $this->record_sales = $record_sales;
        $this->record_expense = $record_expense;
        $this->record_expense_item = $record_expense_item;
    }
    ...
    public function view(): View
    {
        return view($this->view, [
            ...
            'month' => $this->monthSel,
            'recordsalesbudget' => $this->record_sales_budget,
            'recordexpensebudget' => $this->record_expense_budget,
            'recordsales' => $this->record_sales,
            'recordexpense' => $this->record_expense,
            'recordexpenseitem' => $this->record_expense_item,
            'year' => $this->year
        ]);
    }
