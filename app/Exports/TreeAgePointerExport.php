...
class TreeAgePointerExport implements FromView, WithEvents,ShouldAutoSize, WithColumnFormatting
{
    public function __construct($view, $record, $recordpointer, $age, $search)
    {
        $this->view = $view;
        $this->record = $record;
        $this->age =$age;
    ...
    public function view(): View
    {
        return view($this->view, [
            ...
            'age' => $this->age,
            'record' => $this->record,
            'recordpointer' => $this->recordpointer,
        ]);
    }
