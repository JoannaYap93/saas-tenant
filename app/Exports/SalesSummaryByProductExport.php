...
class SalesSummaryByProductExport implements FromView, WithEvents
{
    public function __construct($view, $sales_summary_details_by_product, $search)
    {
        $this->view = $view;
        $this->sales_summary_details_by_product = $sales_summary_details_by_product;
        $this->search = $search;
    }
    ...
    public function view(): View
    {
        return view($this->view, [
            'sales_summary_details_by_product' => $this->sales_summary_details_by_product,
            'search' => $this->search,
