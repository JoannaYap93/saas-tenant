...
class WarehouseReportExport implements FromView, WithEvents,ShouldAutoSize,WithColumnFormatting
{
    public function __construct($view, $wh_sales_rm, $wh_sales_kg, $wh_stock, $search)
    {
        $this->view = $view;
        $this->wh_sales_rm = $wh_sales_rm;
        $this->wh_sales_kg = $wh_sales_kg;
    ...
    public function view(): View
    {
        return view($this->view, [
            'whSalesRm' => $this->wh_sales_rm,
            'whSalesKg' => $this->wh_sales_kg,
            'whStock' => $this->wh_stock,
            'search' => $this->search,
            'companySel' => Company::get_company_sel_warehouse(),
            'warehouses' => SettingWarehouse::get_warehouse_for_expense(),
            'monthSel' => Reporting::get_month_w_filter($this->search),
            'companies' => Company::get_company_for_warehouse_report($this->search),
        ]);
    }
