...
class ProfitLossReportExport implements FromView, WithEvents, ShouldAutoSize, WithColumnFormatting
{
    public function __construct($view, $sales, $expense, $expense_items, $search)
    {
        $this->view = $view;
        $this->sales = $sales;
