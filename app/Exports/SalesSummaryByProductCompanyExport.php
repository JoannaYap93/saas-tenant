...
class SalesSummaryByProductCompanyExport implements FromView, WithEvents, ShouldAutoSize
{
    public function __construct($view, $sales_summary_details_by_product_company, $search)
    {
        $this->view = $view;
        $this->sales_summary_details_by_product_company = $sales_summary_details_by_product_company;
        $this->search = $search;
    }
    ...
    public function view(): View
    {
        return view($this->view, [
            'records' => $this->sales_summary_details_by_product_company,
            'search' => $this->search,
